<template>
  <div
    class="sb-component sb-component-section sb-component-hero-section colors-f flex flex-col justify-center min-h-0 mt-0 mb-0 ml-0 mr-0 pt-36 pb-48 pl-4 pr-4"
  >
        ...
        >
          <div class="flex-1 w-full">
            ...
            <p class="text-xl sm:text-2xl text-left mt-4">
              ...
              details and credentials about me.
            </p>
          </div>
        </div>
      </div>
